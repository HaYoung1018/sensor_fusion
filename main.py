...
plt.scatter([pos[0] for pos in cam_positions], [pos[1] for pos in cam_positions], label='Camera', alpha=0.5)
plt.scatter([pos[0] for pos in lidar_positions], [pos[1] for pos in lidar_positions], label='Lidar', alpha=0.5)
plt.scatter([pos[0] for pos in smoothed_positions], [pos[1] for pos in smoothed_positions], label='Smoothed', alpha=0.5)
plt.xlabel('X Position')
plt.ylabel('Y Position')
plt.legend()
plt.title('Sensor Fusion Trajectories')
plt.show()
# 결과를 CSV 파일로 저장
